...
This repository contains a completed 8-bit CPU adhering to Von Neuman architecture and built in Logisim as a .circ file. The project was challenging because getting the ALU, registers, RAM, main bus, and control logic to work together required careful debugging and attention to timing.
